...
urlpatterns = [
	...
	path("fileupload/", FileUploadViewSet.as_view({'get': 'list', 'post' : 'create'}), name="upload video in our course"),
	...
	path("chapter/<pk>/", myChapter, name="current user all chapter"),
